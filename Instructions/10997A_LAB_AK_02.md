...
3. Sign in as  **Holly@Adatumyyxxxxx.onmicrosoft.com**, where **_yyxxxxx_** is your unique Adatum domain number, by using Holly's password.
...
11. Verify that  **Adatumyyxxxxx.onmicrosoft.com** is listed in the text box after the at sign (@), where **_yyxxxxx_** is your unique Adatum domain number, and then click **Add**.
...
4. In the  **Sign in to your account** dialog box, sign in as **Holly@Adatumyyxxxxx.onmicrosoft.com**, where  **_yyxxxxx_** is your unique Adatum number, by using Holly's password.

5. At the command prompt, type the following command, and then press Enter (Replace **_yyxxxxx_** with your unique Adatum domain number.) Provide a password that meets the complexity requirements.
...
6. At the command prompt, type the following command, and then press Enter (Replace **_yyxxxxx_** with your unique Adatum domain number.) Provide a password that meets the complexity requirements.
...
9. To license Catherine Richard, at the command prompt, type the following command, and then press Enter (Replace **_yyxxxxx_** with your unique Adatum domain number):
...
10. To license Tameka Reed, at the command prompt, type the following command, and then press Enter (Replace **_yyxxxxx_** with your unique Adatum domain number):

  ```
  Set-MsolUserLicense -UserPrincipalName Tameka@Adatumyyxxxxx.onmicrosoft.com -AddLicenses "Adatumyyxxxxx:ENTERPRISEPREMIUM"
  ```

11. To prevent a user from signing in, at the command prompt, type the following command, and then press Enter (Replace **_yyxxxxx_** with your unique Adatum domain number):

  ```
  Set-MsolUser -UserPrincipalName Catherine@Adatumyyxxxxx.onmicrosoft.com -BlockCredential $true
  ```

12. To delete a user, at the command prompt, type the following command, and then press Enter;  (Replace **_yyxxxxx_** with your unique Adatum domain number):
...
15. To restore a deleted user, at the command prompt, type the following command, and then press Enter (Replace **_yyxxxxx_** with your unique Adatum domain number):
...
20. To allow a user to sign in, at the command prompt, type the following command, and then press Enter (Replace **_yyxxxxx_** with your unique Adatum domain number):
...
1. At the Windows Azure Active Directory Module for Windows PowerShell prompt on  **LON-CL1**, type the following command, and then press Enter (Replace **_yyxxxxx_** with your unique Adatum domain number). Provide a password that meets the complexity requirements:
...
2. Sign in as  **Holly@Adatumyyxxxxx.onmicrosoft.com**, where **_yyxxxxx_** is your unique Adatum domain number, by using Holly's password.
...
1. In the Windows Azure Active Directory Module for Windows PowerShell window on  **LON-CL1**, at the command prompt, type the following command, and then press Enter; where **_yyxxxxx_** is your unique Adatum domain number:

  ```
  Add-MsolRoleMember -RoleName "Service Support Administrator" -RoleMemberEmailAddress "Sallie@Adatumyyxxxxx.onmicrosoft.com"
  ```

2. At the command prompt, type the following command, and then press Enter; where **_yyxxxxx_** is your unique Adatum domain number:
...
2. Sign in as  **Tameka@Adatumyyxxxxx.onmicrosoft.com**, where  **_yyxxxxx_** is your unique Adatum domain number, by using the password assigned to Tameka's account.
...
6. If prompted, sign in again as  **Tameka@Adatumyyxxxxx.onmicrosoft.com**, where  **_yyxxxxx_** is your unique Adatum domain number, by using the password assigned to Tameka's account.
...
13. Sign in as  **Christie@Adatumyyxxxxx.onmicrosoft.com**, where  **_yyxxxxx_** is your unique Adatum domain number, by using the temporary password that you recorded earlier.
...
16. If prompted, sign in again as  **Christie@Adatumyyxxxxx.onmicrosoft.com**, where  **_yyxxxxx_** is your unique Adatum domain number, by using the password you assigned to Christie's account.
...
2. Sign in as  **Sallie@Adatumyyxxxxx.onmicrosoft.com**, where **_yyxxxxx_** is your unique Adatum domain number, by using the password that you recorded earlier in the lab when you created Sallie's account.
...
4. In the  **Sign in to your account** dialog box, sign in as **Holly@Adatumyyxxxxx.onmicrosoft.com**, where  **_yyxxxxx_** is your unique Adatum domain number, by using Holly's password.
...
2. Sign in as  **Sallie@Adatumyyxxxxx.onmicrosoft.com**, where **_yyxxxxx_** is your unique Adatum domain number, by using the password you assigned to Sallie's account.
