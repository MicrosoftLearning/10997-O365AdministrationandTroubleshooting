...
In  **File Explorer**, in Office16 folder, right-click  **configuration.xml**, and then click  **Copy**. Right click in an empty area in the folder, and then click  **Paste**.

2. Click (to select) and then right-click the  **configuration.xml** file; click **Open with**, and then click  **Notepad**.
...
4. In  **Notepad**, remove all the remaining comment codes in the lines that start with  "**&lt;!--**" and end with "**--&gt;**" so each line begins with a "**&lt;**".

5. To make the download quicker, comment out Microsoft Visio section with the codes  "**&lt;!--**" and "**--&gt;**", **by replacing this code:**
...
6. The entire file, beginning with "**&lt;Configuration&gt;**", should look like this:
...
>  **NOTE:** On the **Save As** window, be sure to change the "**Save as type...**" to: "**All files (\*.\*)**".
...
14. Switch to  **File Explorer**, and verify that the download has started in the  **Office16** folder. The existence of the **Office** folder verifies this. You can continue with the next task and leave the download running in the background.
...
1. On  **LON-CL1**, switch to Microsoft Edge, browse to  [**https://portal.office.com**](https://portal.office.com), and then sign in as  **Holly@Adatumyyxxxxx.onmicrosoft.com**, where **_yyxxxxx_** is your unique Adatum domain number, by using Holly's password.
...
16. On the  **Sign in** page, at [**https://portal.office.com**](https://portal.office.com), sign in as  **Abbi@Adatumyyxxxxx.onmicrosoft.com**, where **_yyxxxxx_** is your unique Adatum domain number, by using Abbi's password.
...
20. On the  **Sign in** page, in the **Name** box, type **Beth@Adatumyyxxxxx.onmicrosoft.com**, where **_yyxxxxx_** is your unique Adatum domain number.
...
28. Sign in as  **Holly@Adatumyyxxxxx.onmicrosoft.com**, where **_yyxxxxx_** is your unique Adatum domain number.
...
37. On the  **Sign in** page, in the **Name** box, type **Beth@Adatumyyxxxxx.onmicrosoft.com**, where **_yyxxxxx_** is your unique Adatum domain number.
...
9. In the top-right corner, if no one is signed in click the link  **Sign in to get most out of office.** Sign in as **Beth@Adatumyyxxxxx.onmicrosoft.com**, where **_yyxxxxx_** is your unique Adatum domain number, using Beth's password.
...
14. On the  **Sign in** page, in the **E-mail address** box, type **Holly@Adatumyyxxxxx.onmicrosoft.com**, where **_yyxxxxx_** is your unique Adatum domain number, and then click  **Next**.
...
2. Sign back in as Holly Spencer with the username  **Holly@Adatumyyxxxxx.onmicrosoft.com**, where **_yyxxxxx_** is your unique Adatum domain number.
...
9. On the  **Sign in** page, type **Beth@Adatumyyxxxxx.onmicrosoft.com**, where **_yyxxxxx_** is your unique Adatum domain number.
...
1. Sign out of the  **Office 365** page, and then sign back in as **Holly@Adatumyyxxxxx.onmicrosoft.com**, where **_yyxxxxx_** is your unique Adatum domain number.
...
10. On the  **Activate Office** page, in the **E-mail address** box, type **Beth@Adatumyyxxxxx.onmicrosoft.com**, where **_yyxxxxx_** is your unique Adatum domain number, and then click  **Next**.
...
6. On the  **Sign in** page, in the **Name** box, type **Beth@Adatumyyxxxxx.onmicrosoft.com**, where **_yyxxxxx_** is your unique Adatum domain number.
...
6. On the  **Sign in** page, in the **Name** box, type **Holly@Adatumyyxxxxx.onmicrosoft.com**, where **_yyxxxxx_** is your unique Adatum domain number.
...
18. On the  **Sign in** page, in the **Name** box, type **Beth@Adatumyyxxxxx.onmicrosoft.com**, where **_yyxxxxx_** is your unique Adatum domain number.
